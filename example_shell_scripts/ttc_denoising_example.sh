### This file is not intended to be used to run an experiment. It provides an example of how to train TTC for image denoising and how to evaluate its performance with PSNR using this codebase ###
